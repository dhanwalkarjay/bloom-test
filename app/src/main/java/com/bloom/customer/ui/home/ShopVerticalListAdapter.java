...
import com.bloom.databinding.ItemShopVerticalBinding;
import com.bumptech.glide.Glide;

import java.util.ArrayList;
import java.util.List;

public class ShopVerticalListAdapter extends RecyclerView.Adapter<ShopVerticalListAdapter.ShopViewHolder> {
    ...
    public ShopViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemShopVerticalBinding binding = ItemShopVerticalBinding.inflate(
    ...
    class ShopViewHolder extends RecyclerView.ViewHolder {
        private final ItemShopVerticalBinding binding;

        ShopViewHolder(ItemShopVerticalBinding binding) {
